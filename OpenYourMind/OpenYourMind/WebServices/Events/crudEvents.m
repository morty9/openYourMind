...
- (void) getEvent:(void (^)(NSError *error, BOOL success))callback {
    ...
    if (data) {
        ...
        for (NSDictionary* session in jsonDict) {
            ...
            Event* e = [[Event alloc] initWithId:[tmp_id integerValue] description:tmp_description date:tmp_date salle:tmp_salle id_asso:[tmp_id_asso integerValue]];
...
- (void) getEventById:(NSInteger*)eventId callback:(void (^)(NSError *error, BOOL success))callback {
    ...
    [[[NSURLSession sharedSession] dataTaskWithRequest:request completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            self.event = [[Event alloc] initWithId:[tmp_id integerValue] description:tmp_description date:tmp_date salle:tmp_salle id_asso:[tmp_id_asso integerValue]];
